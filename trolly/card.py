...
class Card( TrelloObject ):
    ...
    def moveTo( self, idBoard, idList, pos='bottom' ):
        return self.fetchJson( 
                uri_path = self.base_uri,
                http_method = 'PUT',
    ...
    def removeComments( self, id_action ):
        """
        Remove a label from this card.
        """
        return self.fetchJson( 
                uri_path = self.base_uri + '/actions/' + id_action + '/comments',
                http_method = 'DELETE',
            )
    ...
    def removeLabel( self, label):
        ...
        """
        return self.fetchJson( 
                uri_path = self.base_uri + '/labels/' + label,
                http_method = 'DELETE',
            )
